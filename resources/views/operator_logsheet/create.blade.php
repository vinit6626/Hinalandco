      ...
      <div class="row">
        ...
        <div class="col-md-6" >
          ...
          <div class="box box-primary" style="box-shadow: 5px 5px 5px grey;">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="{{url('/ologsheet')}}" enctype= multipart/form-data>
              @csrf
              <div class="box-body">
                <div class="form-group">
                  <label for="name">Machine Number / मशीन नंबर <sup style="color: red; font-size: 16px;">*</sup></label>
                ...
                <div class="form-group">
                  <label for="name">Machine Status / स्थिति <sup style="color: red; font-size: 16px;">*</sup></label>&nbsp;&nbsp;&nbsp;
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Logsheet Photo / लॉगशीट फोटो<sup style="color: red; font-size: 16px;">*</sup></label>
